...
(use-package dashboard
  ...
  (defun centre-title (str)
    (let* ((len (length str))
           (padding (make-string (- 38 (/ len 2))
                                 ?\s)))
      (concat padding str)))
  ...
  (setq dashboard-banner-logo-title (centre-title "W I T C H M A C S - The cutest Emacs distribution!"))
  (setq dashboard-startup-banner "~/.emacs.d/DMGmacs.png")
